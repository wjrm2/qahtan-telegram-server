...
def get_system_message(uid):
    ...
    return (
        ...
        "لا تخمّن أعداد الأعضاء أو حالة القناة أو نجاح النشر أو الروابط. بيانات Telegram لا تُذكر إلا بعد استدعاء أداة تحقق فعلية، وإلا قل إنك لا تعرف. "
...
async def post_init(app):
    commands = [
        ...
        BotCommand("channelinfo", "تحقق من بيانات قناة"),
        ...
        BotCommand("promote", "رفع بصلاحيات محدودة"),
        BotCommand("demote", "خفض الصلاحيات"),
        BotCommand("promote_full", "رفع مشرف بكامل الصلاحيات"),
        BotCommand("demote_full", "تنزيل مشرف بالكامل"),
        BotCommand("promote_kick", "رفع بصلاحية الطرد"),
        BotCommand("demote_kick", "تنزيل صلاحية الطرد"),
        BotCommand("promote_ban", "رفع بصلاحية الحظر"),
        BotCommand("demote_ban", "تنزيل صلاحية الحظر"),
        BotCommand("promote_restrict", "رفع بصلاحية التقييد"),
        BotCommand("demote_restrict", "تنزيل صلاحية التقييد"),
